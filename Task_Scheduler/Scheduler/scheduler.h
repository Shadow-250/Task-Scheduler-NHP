...
//
//*****************************************************************************
extern tSchedulerTask g_psSchedulerTable[]; // manager task have struct like above
...
//
//*****************************************************************************
extern uint32_t g_ui32SchedulerNumTasks; // The number of task have setting before
...
extern uint32_t SchedulerElapsedTicksCalc(uint32_t ui32TickStart,uint32_t ui32TickEnd);
